...
const allArtifacts: Artifact[] = [
  ...
  },
  {
    id: 'art-4',
    siteId: 'site-2',
    title: 'Lakshmi Narasimha Statue',
    description: 'A colossal monolithic statue of Lakshmi Narasimha, the fourth incarnation of Lord Vishnu. This masterpiece of Vijayanagara art is located in Hampi.',
  ...
  },
  {
    id: 'art-5',
    siteId: 'site-2',
    title: 'Harihara Statue',
    description: 'A statue representing Harihara, a fused deity form of Vishnu (Hari) and Shiva (Hara) from Hindu mythology. This represents the synthesis of two major Hindu traditions.',
  ...
  },
  {
    ...
    siteId: 'site-8',
    title: 'Chhau Mask',
    description: 'A traditional cultural heritage of Purulia, West Bengal, the Chhau mask is used in the Chhau dance, a semi-classical Indian dance with martial, tribal, and folk origins.',
  ...
  },
  {
    ...
    siteId: 'site-4',
    title: 'Konark Wheel',
    description: "One of the 24 intricately carved stone wheels of the Konark Sun Temple's chariot structure. These wheels are not just decorative but also function as sundials.",
